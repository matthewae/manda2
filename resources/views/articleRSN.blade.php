...
<head>
    ...
    <title>Epoxy Building Project</title>
        ...
        <div class="absolute inset-0 bg-black/50">
            <div class="container mx-auto px-4 h-full flex items-end pb-16">
                <div class="text-white fade-in">
                    ...
                    <h1 class="text-5xl font-bold mt-4 mb-2">Pemasangan Teralis Rusunawa Pulo</h1>
                ...
                <div class="lg:col-span-2">
                    <section class="bg-white p-8 rounded-xl shadow-lg mb-8">
                        ...
                        <p class="text-gray-600 leading-relaxed mb-8">
                            The installation of grilles at Rusunawa Pulo aims to enhance the safety and security of the residents.
                            This project reflects our commitment to delivering high-quality construction solutions while ensuring the well-being of the community.
                        </p>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                            <div class="aspect-[4/3] overflow-hidden rounded-lg shadow-lg">
                                <img src="{{ url('images/img219.jpg') }}"
                                    alt="Station Interior"
                                    class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                            </div>
                            <!-- <div class="aspect-[4/3] overflow-hidden rounded-lg shadow-lg">
                                <img src="{{ url('images/img207.jpg') }}"
                                    alt="Train Platform"
                                    class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                            </div> -->
                        </div>
                    ...
                    <div class="sticky top-8 space-y-6">
                        ...
                        <div class="bg-white p-6 rounded-xl shadow-lg">
                            ...
                            <ul class="space-y-3 text-gray-600">
                                ...
                                <li class="flex justify-between">
                                    <span>Client:</span>
                                    <span>UPRS VII DKI Jakarta</span>
                                </li>
                            </ul>
                        </div>
    ...
    <footer class="bg-gray-900 text-white py-8 md:py-16">
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 border-b border-gray-700 pb-8 md:pb-12 mb-8 md:mb-12">
                ...
                <a href="/articleEPO" class="group block p-4 md:p-0 bg-gray-800/50 md:bg-transparent rounded-lg md:rounded-none hover:bg-gray-800 md:hover:bg-transparent transition-colors">
                ...
                <a href="/articleSPP" class="group block p-4 md:p-0 bg-gray-800/50 md:bg-transparent rounded-lg md:rounded-none hover:bg-gray-800 md:hover:bg-transparent transition-colors">
            ...
            <div class="grid grid-cols-1 gap-8 md:grid-cols-3 md:gap-12">
                ...
                <div class="p-4 md:p-0">
                    ...
                    This project highlights our dedication to safety and quality in residential construction. 
                    By enhancing security features, we contribute to a safer and more comfortable living environment for the community.
                    </p>
                </div>
