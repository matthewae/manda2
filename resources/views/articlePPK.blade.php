        ...
        <div class="absolute inset-0 bg-black/50">
            <div class="container mx-auto px-4 h-full flex items-end pb-16">
                <div class="text-white fade-in">
                    ...
                    <h1 class="text-5xl font-bold mt-4 mb-2">Panduan Pelaksanaan Konstruksi Di Kota Bandung</h1>
                ...
                <div class="lg:col-span-2">
                    <section class="bg-white p-8 rounded-xl shadow-lg mb-8">
                        ...
                        <p class="text-gray-600 leading-relaxed mb-8">
                            This guideline provides a comprehensive approach to modern construction practices
                            in Bandung City, ensuring sustainable development and safety standards.
                        </p>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                            <div class="aspect-[4/3] overflow-hidden rounded-lg shadow-lg">
                                <img src="{{ url('images/img307.jpg') }}"
                                    alt="Station Interior"
                                    class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                            </div>
                            <div class="aspect-[4/3] overflow-hidden rounded-lg shadow-lg">
                                <img src="{{ url('images/img306.jpg') }}"
                                    alt="Train Platform"
                                    class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                            </div>
                        </div>
                    ...
                    <div class="sticky top-8 space-y-6">
                        ...
                        <div class="bg-white p-6 rounded-xl shadow-lg">
                            ...
                            <ul class="space-y-3 text-gray-600">
                                ...
                                <li class="flex justify-between">
                                    <span>Service:</span>
                                    <span>Study Of Administration</span>
                                </li>
                                <li class="flex justify-between">
                                    <span>Status:</span>
            ...
            <div class="grid grid-cols-1 gap-8 md:grid-cols-3 md:gap-12">
                ...
                <div class="p-4 md:p-0">
                    ...
                    <p class="text-gray-400 text-sm md:text-base">
                        This guide provides comprehensive insights into the construction implementation process
                        in Bandung City, ensuring compliance with local regulations and best practices in urban development.
                    </p>
                </div>
