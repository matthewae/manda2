        ...
        <div class="absolute inset-0 bg-black/50">
            <div class="container mx-auto px-4 h-full flex items-end pb-16">
                <div class="text-white fade-in">
                    ...
                    <h1 class="text-5xl font-bold mt-4 mb-2">Kajian Pengembangan Perumahan</h1>
                ...
                <div class="lg:col-span-2">
                    <section class="bg-white p-8 rounded-xl shadow-lg mb-8">
                        ...
                        <p class="text-gray-600 leading-relaxed mb-8">
                            This project focuses on analyzing residential development potential in urban areas.
                            This study includes strategic planning, feasibility analysis, and the impact on community well-being.
                            It aims to provide sustainable and affordable housing solutions tailored to local needs.
                        </p>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                            <div class="aspect-[4/3] overflow-hidden rounded-lg shadow-lg">
                                <img src="{{ url('images/img294.jpg') }}"
                                    alt="Station Interior"
                                    class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                            </div>
                            <div class="aspect-[4/3] overflow-hidden rounded-lg shadow-lg">
                                <img src="{{ url('images/img295.jpg') }}"
                                    alt="Train Platform"
                                    class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                            </div>
                        </div>
    ...
    <footer class="bg-gray-900 text-white py-8 md:py-16">
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 border-b border-gray-700 pb-8 md:pb-12 mb-8 md:mb-12">
                ...
                <a href="/articleSDE" class="group block p-4 md:p-0 bg-gray-800/50 md:bg-transparent rounded-lg md:rounded-none hover:bg-gray-800 md:hover:bg-transparent transition-colors">
                ...
                <a href="/articlePPK" class="group block p-4 md:p-0 bg-gray-800/50 md:bg-transparent rounded-lg md:rounded-none hover:bg-gray-800 md:hover:bg-transparent transition-colors">
            ...
            <div class="grid grid-cols-1 gap-8 md:grid-cols-3 md:gap-12">
                ...
                <div class="p-4 md:p-0">
                    ...
                    This aims to provide strategic insights and sustainable solutions for residential development.
                    Our approach ensures community well-being and affordable housing while considering environmental and social impacts.
                    </p>
                </div>
