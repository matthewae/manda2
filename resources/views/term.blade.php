...
<head>
    ...
    <title>Terms of Service - Mandajaya Rekayasa Konstruksi</title>
...
<body class="font-roboto">
    ...
    <div class="bg-gray-900 text-white py-6 px-4 shadow-lg">
    ...
    <div class="bg-gray-100 py-3 px-4 border-b">
        <div class="container mx-auto max-w-4xl">
            <div class="flex items-center text-sm text-gray-600">
                ...
                <span class="text-gray-800">Terms of Service</span>
            </div>
        </div>
    </div>

    <!-- Terms of Service -->
    <section class="py-8 md:py-16 bg-gradient-to-b from-gray-100 to-white fade-in">
        <div class="container mx-auto px-4 max-w-4xl">
            <!-- Header -->
            <div class="text-center mb-8 md:mb-12">
                <h1 class="text-3xl md:text-4xl font-bold mb-3 md:mb-4">Terms of Service</h1>
                <div class="w-20 md:w-24 h-1 bg-blue-500 mx-auto mb-4 md:mb-6"></div>
                <p class="text-sm md:text-base text-gray-600">Last updated: February 14, 2024</p>
            </div>

            <!-- Content -->
            <div class="space-y-6 md:space-y-8 text-gray-700">
                <!-- Agreement to Terms -->
                <div class="bg-white rounded-lg shadow-sm p-6 md:p-8 hover:shadow-md transition duration-300">
                    <h2 class="text-xl md:text-2xl font-bold mb-4 text-gray-800 flex items-center">
                        <span class="text-blue-500 mr-2">1.</span> Agreement to Terms
                    </h2>
                    <p class="text-base md:text-lg leading-relaxed">
                        By accessing or using the services of Mandajaya Rekayasa Konstruksi, you agree to be bound by these Terms of Service. If you disagree with any part of these terms, you may not access our services.
                    </p>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm p-6 md:p-8 hover:shadow-md transition duration-300">
                    <h2 class="text-xl md:text-2xl font-bold mb-4 text-gray-800 flex items-center">
                        <span class="text-blue-500 mr-2">2.</span> Services Description
                    </h2>
                    <p class="text-base md:text-lg mb-4">We provide construction consulting services, including but not limited to:</p>
                ...
                <div class="bg-white rounded-lg shadow-sm p-6 md:p-8 hover:shadow-md transition duration-300">
                    <h2 class="text-xl md:text-2xl font-bold mb-4 text-gray-800 flex items-center">
                        <span class="text-blue-500 mr-2">3.</span> Client Responsibilities
                    </h2>
                    <p class="text-base md:text-lg mb-4">Clients agree to:</p>
                    <ul class="list-none space-y-3">
                        <li class="flex items-start">
                            <i class="fas fa-check-circle text-blue-500 mt-1 mr-3"></i>
                        ...
                        <li class="flex items-start">
                            <i class="fas fa-check-circle text-blue-500 mt-1 mr-3"></i>
                            <span>Cooperate with project requirements</span>
                        </li>
                        <li class="flex items-start">
                            <i class="fas fa-check-circle text-blue-500 mt-1 mr-3"></i>
                            <span>Meet payment obligations as agreed</span>
                        </li>
                        <li class="flex items-start">
                            <i class="fas fa-check-circle text-blue-500 mt-1 mr-3"></i>
                ...
                <div class="bg-white rounded-lg shadow-sm p-6 md:p-8 hover:shadow-md transition duration-300">
                    <h2 class="text-xl md:text-2xl font-bold mb-4 text-gray-800 flex items-center">
                        <span class="text-blue-500 mr-2">4.</span> Intellectual Property
                    </h2>
                    <p class="text-base md:text-lg leading-relaxed mb-4">
                        All content, designs, and documentation produced by Mandajaya Rekayasa Konstruksi remain our exclusive property unless otherwise specified in a written agreement. This includes:
                    </p>
                    <ul class="list-none space-y-3">
                        <li class="flex items-start">
                            <i class="fas fa-check-circle text-blue-500 mt-1 mr-3"></i>
                            <span>Design documents and drawings</span>
                        </li>
                        <li class="flex items-start">
                            <i class="fas fa-check-circle text-blue-500 mt-1 mr-3"></i>
                            <span>Project specifications and plans</span>
                        </li>
                        <li class="flex items-start">
                            <i class="fas fa-check-circle text-blue-500 mt-1 mr-3"></i>
                        ...
                        <li class="flex items-start">
                            <i class="fas fa-check-circle text-blue-500 mt-1 mr-3"></i>
                            <span>Software and technical solutions</span>
                        </li>
                    </ul>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm p-6 md:p-8 hover:shadow-md transition duration-300">
                    <h2 class="text-xl md:text-2xl font-bold mb-4 text-gray-800 flex items-center">
                        <span class="text-blue-500 mr-2">5.</span> Limitation of Liability
                    </h2>
                    <p class="text-base md:text-lg leading-relaxed mb-4">
                        Mandajaya Rekayasa Konstruksi shall not be liable for any indirect, incidental, special, consequential, or punitive damages resulting from:
                    </p>
                    <ul class="list-none space-y-3">
                        <li class="flex items-start">
                            <i class="fas fa-exclamation-circle text-yellow-500 mt-1 mr-3"></i>
                            <span>Use or inability to use our services</span>
                        </li>
                        <li class="flex items-start">
                            <i class="fas fa-exclamation-circle text-yellow-500 mt-1 mr-3"></i>
                            <span>Any unauthorized access to our services</span>
                        </li>
                        <li class="flex items-start">
                            <i class="fas fa-exclamation-circle text-yellow-500 mt-1 mr-3"></i>
                ...
                <div class="bg-white rounded-lg shadow-sm p-6 md:p-8 hover:shadow-md transition duration-300">
                    <h2 class="text-xl md:text-2xl font-bold mb-4 text-gray-800 flex items-center">
                        <span class="text-blue-500 mr-2">6.</span> Changes to Terms
                    </h2>
                    <p class="text-base md:text-lg leading-relaxed">
                        We reserve the right to modify these terms at any time. We will notify clients of any material changes via email or through our website. Your continued use of our services following such changes constitutes your acceptance of the modified terms.
                    </p>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm p-6 md:p-8 hover:shadow-md transition duration-300">
                    <h2 class="text-xl md:text-2xl font-bold mb-4 text-gray-800 flex items-center">
                        <span class="text-blue-500 mr-2">7.</span> Legal Framework
                    </h2>
                    <p class="text-base md:text-lg leading-relaxed mb-4">
                        Our services comply with Indonesian construction consulting regulations, including:
                    </p>
                    <ul class="list-none space-y-3">
                        <li class="flex items-start">
                            <i class="fas fa-gavel text-blue-500 mt-1 mr-3"></i>
                            <span>
                                <strong class="block text-gray-800">UU No. 2 Tahun 2017</strong>
                                <span class="text-gray-600">Law concerning Construction Services that regulates construction consulting activities</span>
                            </span>
                        </li>
                        <li class="flex items-start">
                            <i class="fas fa-gavel text-blue-500 mt-1 mr-3"></i>
                            <span>
                                <strong class="block text-gray-800">PP No. 22 Tahun 2020</strong>
                                <span class="text-gray-600">Government Regulation on Implementation of Construction Services</span>
                            </span>
                        </li>
                        <li class="flex items-start">
                            <i class="fas fa-gavel text-blue-500 mt-1 mr-3"></i>
                            <span>
                                <strong class="block text-gray-800">Permen PUPR No. 6 Tahun 2021</strong>
                                <span class="text-gray-600">Ministry Regulation on Construction Service Business Licenses</span>
                            </span>
                        </li>
                    </ul>

                    <div class="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-100">
                        <h3 class="text-lg font-semibold text-gray-800 mb-3">Key Compliance Areas:</h3>
                        <ul class="list-none space-y-3">
                            <li class="flex items-start">
                                <i class="fas fa-shield-alt text-blue-500 mt-1 mr-3"></i>
                                <span>Professional certification and licensing requirements</span>
                            </li>
                            <li class="flex items-start">
                                <i class="fas fa-shield-alt text-blue-500 mt-1 mr-3"></i>
                                <span>Quality standards and safety regulations</span>
                            </li>
                            <li class="flex items-start">
                                <i class="fas fa-shield-alt text-blue-500 mt-1 mr-3"></i>
                            ...
                            <li class="flex items-start">
                                <i class="fas fa-shield-alt text-blue-500 mt-1 mr-3"></i>
                                <span>Worker protection and safety standards</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="mt-6 text-sm text-gray-600">
                        <p class="italic">
                            Note: These regulations are subject to updates and amendments. We maintain compliance with the latest versions of all applicable laws and regulations.
                        </p>
                    </div>
                </div>
                <!-- Contact Information -->
                <!-- <div class="bg-white rounded-lg shadow-sm p-6 md:p-8 hover:shadow-md transition duration-300">
                    <h2 class="text-xl md:text-2xl font-bold mb-4 text-gray-800 flex items-center">
                        <span class="text-blue-500 mr-2">7.</span> Contact Information
                    </h2>
                    ...
                    <div class="bg-gray-50 p-6 rounded-lg">
                        <ul class="list-none space-y-4">
                            <li class="flex items-start">
                                ...
                                <span><strong>Mandajaya Rekayasa Konstruksi</strong></span>
                            </li>
                            <li class="flex items-start">
                                <i class="fas fa-map-marker-alt text-blue-500 mt-1 mr-3"></i>
                                <span>Jl. Kota Mas 1 No.18, Kota Cimahi, Jawa Barat, 40511</span>
                            </li>
                            <li class="flex items-start">
                                <i class="fas fa-envelope text-blue-500 mt-1 mr-3"></i>
                                <span>contact.us@mandajayarekayasakonstruksi.com</span>
                            </li>
                            <li class="flex items-start">
                                <i class="fas fa-phone text-blue-500 mt-1 mr-3"></i>
                                <span>+62 852 2080 1593</span>
                            </li>
                        </ul>
                    </div>
                </div> -->
