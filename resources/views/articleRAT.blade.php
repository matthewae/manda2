        ...
        <div class="absolute inset-0 bg-black/50">
            <div class="container mx-auto px-4 h-full flex items-end pb-16">
                <div class="text-white fade-in">
                    ...
                    <h1 class="text-5xl font-bold mt-4 mb-2">Kajian Resiko Pada Ruas Tol Palembang Betung</h1>
                ...
                <div class="lg:col-span-2">
                    <section class="bg-white p-8 rounded-xl shadow-lg mb-8">
                        ...
                        <p class="text-gray-600 leading-relaxed mb-8">
                            This project involves a comprehensive risk assessment study on the Palembang Betung Toll Road.
                            The study aims to identify potential risks, analyze their impacts, and provide strategic solutions
                    ...
                    <div class="sticky top-8 space-y-6">
                        ...
                        <div class="bg-white p-6 rounded-xl shadow-lg">
                            ...
                            <ul class="space-y-3 text-gray-600">
                                ...
                                <li class="flex justify-between">
                                    <span>Client:</span>
                                    <span>PT.Varian Global Perencana</span>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="grid grid-cols-1 gap-8 md:grid-cols-3 md:gap-12">
                ...
                <div class="p-4 md:p-0">
                    ...
                    <p class="text-gray-400 text-sm md:text-base">
                        This risk assessment project demonstrates our commitment to enhancing infrastructure safety
                        and operational efficiency through strategic risk management and innovative solutions.
                    </p>
                </div>
